        ...
        <div class="products card mt-5">
            ...
            <div class="card-body row gap-3">
                <div class="card col-12 col-md w-100 p-0" style="width:18rem;">
                    <img style="max-height:16rem;object-fit:cover" src="./images/test-img.png" class="card-img-top">
                    <div class="card-body">
                ...
                <div class="card col-12 col-md w-100 p-0">
                    <img style="max-height:16rem;object-fit:cover" src="./images/test-img-2.png" class="card-img-top">
                    <div class="card-body">
                        <h3 class="fs-4 fw-4 text-center card-title">test produit</h3>
                        <div class="text-center">
                            <span class="text-decoration-line-through">230DT</span>
                ...
                <div class="card col-12 col-md w-100 p-0" style="width:18rem;">
                    <img style="max-height:16rem;object-fit:cover" src="./images/test-img-3.png" class="card-img-top" style alt="...">
                    <div class="card-body">
                        <h3 class="fs-4 fw-4 text-center card-title">test produit</h3>
                        <div class="text-center">
                            <span class="text-decoration-line-through">230DT</span>
                ...
                <div class="card col-12 col-md w-100 p-0" style="width:18rem;">
                    <img style="max-height:16rem;object-fit:cover" src="./images/test-img-5.png" class="card-img-top" style alt="...">
                    <div class="card-body">
                        <h3 class="fs-4 fw-4 text-center card-title">test produit</h3>
                        <div class="text-center">
                            <span class="text-decoration-line-through">230DT</span>
                ...
                <div class="card col-12 col-md w-100 p-0" style="width:18rem;">
                    <img style="max-height:16rem;object-fit:cover" src="./images/test-img.png" class="card-img-top" style alt="...">
                    <div class="card-body">
                        <h3 class="fs-4 fw-4 text-center card-title">test produit</h3>
                        <div class="text-center">
                            <span class="text-decoration-line-through">230DT</span>
